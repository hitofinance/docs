...
When a user stakes their HYPE using the Staking Contract, they will receive a certain amount of hHYPE based on the amount of HYPE staked at the current exchange rate for the hHYPE. The exchange rate for the mHYPE is determined by supply and demand, and it can fluctuate over time.
