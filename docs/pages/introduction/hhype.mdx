---
title: Liquid Staking Token - hHYPE
description: The hHYPE token represents a sophisticated financial instrument that enables token holders to maintain liquidity while participating in the staking mechanism. 
---
...
The hHYPE exchange rate $C_{i}$ is determined by a number of factors, including:
